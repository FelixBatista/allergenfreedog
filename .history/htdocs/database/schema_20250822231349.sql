...
-- Append to ingredient master (new ingredients only; none removed/duplicated from your seed)
...
-- Append to food catalog (real retail/brand recipes; none of your sample rows removed)
