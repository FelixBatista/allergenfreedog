...
('lecithin', '[]', '[]', 'Phospholipid emulsifier (often soy- or sunflower-derived)', 'safe'),
('parsley', '[]', '[]', 'Herb/botanical', 'safe'),
('citric acid', '[]', '[]', 'Natural preservative', 'safe'),
('salt', '["sodium chloride","sea salt"]', '[]', 'Electrolyte; preservative', 'safe'),
('cinnamon', '[]', '[]', 'Spice/botanical', 'safe'),
('turmeric', '[]', '[]', 'Spice; source of curcumin', 'safe'),
('green tea extract', '[]', '[]', 'Botanical antioxidant', 'safe'),
('spearmint extract', '[]', '[]', 'Botanical extract', 'safe'),
...
('cod liver oil', '[]', '["possible"]', 'Fish oil (vitamin A/D source)', 'warn'),
