...
('montmorillonite clay', '[]', '[]', 'Natural clay; anti-caking/trace minerals', 'safe'),
('porcine plasma', '["spray dried porcine plasma"]', '["possible"]', 'Functional animal protein; palatant', 'warn'),
('kale', '[]', '[]', 'Leafy green vegetable (dried)', 'safe'),
('mushrooms', '[]', '[]', 'Dried culinary mushrooms (non-toxic species)', 'safe'),
('apricot', '[]', '[]', 'Fruit inclusion (flesh; pits excluded)', 'safe'),
('artichoke', '[]', '[]', 'Vegetable inclusion', 'safe'),
