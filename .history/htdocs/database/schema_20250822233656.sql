...
('Original Air-Dried Lamb', 'Ziwi Peak', 'lamb, lamb tripe, lamb lung, lamb heart, lamb liver, lamb bone, New Zealand green mussel, lamb kidney, lamb spleen, lecithin, parsley, dried apple pomace, inulin (chicory), dried organic kelp, salt, preservative (citric acid, mixed tocopherols), vitamins, minerals', FALSE),
('Harvest Chicken & Ancient Grains', 'Open Farm', 'chicken, oats, ocean whitefish meal, millet, quinoa, coconut oil, herring meal, natural flavor, pumpkin, sorghum, salmon oil, apples, chia seed, potassium chloride, salt, chicory root, vitamin & mineral premix, cinnamon, turmeric, rosemary extract', FALSE),
('Four-Star Hasen Duckenpfeffer', 'Fromm', 'rabbit, duck, pork, pork meat & bone meal, chickpeas, lentils, potatoes, carrots, celery, vitamin & mineral premix, mixed tocopherols', FALSE),
('Carnivore Salmon + Cod (Grain-Free)', 'GO! Solutions', 'deboned salmon, deboned cod, salmon meal, peas, herring meal, pea flour, canola oil, lentils, chickpeas, tapioca, vitamins & minerals, mixed tocopherols', FALSE),
('Singles LID Pork & Squash', 'ACANA', 'deboned pork, pork meal, pork liver, sweet potato, whole chickpeas, pork fat, whole lentils, lentil fiber, pollock oil, whole butternut squash, natural pork flavor, vitamins & minerals', FALSE),
('N&D Quinoa Skin & Coat Herring', 'Farmina', 'herring, pea starch, herring oil, quinoa seed, flaxseed, dried coconut, turmeric, inulin, fructo-oligosaccharide, yeast extract, calcium carbonate, dicalcium phosphate, psyllium seed husk, potassium chloride, salt, brewers dried yeast, aloe vera extract, glucosamine, chondroitin, vitamins & minerals', FALSE),
('Regional Red', 'ORIJEN', 'beef, wild boar, goat, lamb, lamb liver, beef liver, beef tripe, wild boar liver, mutton, whole mackerel, pork, goat meal, beef meal, lamb meal, vitamins & minerals, mixed tocopherols', FALSE),
('Kangaroo (Limited Ingredient)', 'Zignature', 'kangaroo, kangaroo meal, peas, pea flour, chickpeas, sunflower oil, flaxseed, dehydrated alfalfa meal, lentils, natural flavor, pea protein, calcium carbonate, salt, vitamins & minerals, mixed tocopherols', FALSE),
('N&D Ocean Cod, Spelt, Oats & Orange', 'Farmina', 'cod, dehydrated cod, fish oil (from herring), whole spelt, whole oats, dried beet pulp, dried carrot, alfalfa meal, inulin, fructo-oligosaccharide, yeast extract, dried sweet orange, dried apple, dried pomegranate, dried spinach, psyllium husks and seeds, dried blueberry, salt, brewers dried yeast, turmeric, aloe vera extract, glucosamine, chondroitin, vitamins & minerals', FALSE),
('Raw-Coated Kibble Whitefish & Salmon (SuperBlends)', 'Stella & Chewy’s', 'salmon, ocean fish meal, oatmeal, pearled barley, sunflower oil, pumpkin, quinoa, natural vegetable flavor, cod, coconut flour, salt, pumpkin seed, organic cranberries, organic spinach, organic broccoli, organic beets, organic carrots, organic squash, organic blueberries, inulin (chicory), thyme, sage, rosemary extract, chia seed, cod liver oil, dried kelp, probiotics, vitamins & minerals, mixed tocopherols', FALSE),
...
('Wild Islands Pacific Catch', 'Addiction', 'salmon, mackerel, hoki, ocean fish meal, fava beans, pea protein, eggs, green peas, tapioca, coconut oil, flaxseed, green-lipped mussel, manuka honey, kiwifruit, natural flavor, brewers dried yeast, sea salt, potassium chloride, choline chloride, taurine, vitamins & minerals, mixed tocopherols, rosemary extract, tea extract, spearmint extract, buffered vinegar', FALSE),
('Red Coat Salmon & Krill', 'Nature’s Protection', 'salmon meal, dried potato, sweet potato, poultry fat, krill meal, dried beet pulp, salmon oil, flaxseed, fructo-oligosaccharide, yucca schidigera extract, dried cranberries, marigold, vitamins & minerals, mixed tocopherols, rosemary extract', FALSE);
